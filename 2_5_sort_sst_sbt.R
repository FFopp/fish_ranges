...
setwd('/Users/Fabian/Documents/ETH/Landscape Ecology/Paper - Fish Ranges Caribbean 2020/data_2020_04_22/raw_fish_ranges_occ_caribbean')
lib_vect <- c('raster', 'tools')
...
depth_threshold <- 200
for(i in c('sst', 'sbt')){
  input_dir <- file.path(paste0('../fish_ranges_output_combined_', i), 'species_rasters')
  output_dir <- file.path(paste0('../fish_ranges_output_combined_', i), paste0('species_rasters_', i))
